...
Ao solicitar um carro, a Hostess com check-in permite o GPS e compartilha o próprio ponto de encontro. Quando um motorista aceita esse chamado, os dois passam a ver um mapa exclusivo com os marcadores **Hostess** e **Motorista**, a linha entre eles e a distância aproximada para acompanhar a chegada. Nenhum outro motorista, administrador ou consultor recebe a posição da Hostess. O ponto é atualizado somente enquanto o painel dela permanece aberto, expira sem sinal recente e é apagado ao encerrar o pedido, sair da conta, terminar o expediente ou zerar a operação.
...
- A Hostess pode abrir uma solicitação simples de carro após o check-in e permitir o ponto de encontro pelo GPS. Os motoristas com check-in, livres e disponíveis recebem o chamado no Painel Geral e assumem uma solicitação; ao aceitar, ficam em **apoio à Hostess**, veem somente a posição da solicitante daquele chamado e não podem ser usados em tour, Casa, Galeria ou destino. Hostess e motorista acompanham os dois pontos e a distância no mapa privado até o encerramento. Quando esse motorista encerra o apoio, a solicitação vinculada é encerrada automaticamente e ele volta a ficar disponível. A Hostess ou o administrador também podem encerrar o próprio pedido antes disso; em todos os casos, a posição da Hostess é removida.
